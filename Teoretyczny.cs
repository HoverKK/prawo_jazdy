...
namespace prawo_jazdy
{
    public partial class Teoretyczny : Form
    {
        ...
        public Teoretyczny()
        {
            ...
            InitializeTimer();
            DisplayQuestion();
            this.FormClosing += Teoretyczny_FormClosing; // Dodajemy obsługę zdarzenia zamykania formularza
        }
        ...
        private void Teoretyczny_FormClosing(object sender, FormClosingEventArgs e)
        {
